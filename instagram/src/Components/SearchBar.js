...
const SearchBar = (props) => {
    return (
        <div className='top-bar'>
            <header>
            <div className='container'>{/*Instagram logo and Name*/}
