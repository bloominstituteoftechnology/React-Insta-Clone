...
import "./components/CommentContent/CommentContent.css";
import "./components/CommentSection/CommentSection.css";
import "./components/DynamicInput/DynamicInput.css";
import "./components/PostContainer/PostContainer.css";
import "./components/PostContent/PostContent.css";
import "./App.css";
...
class App extends Component {
  ...
  addComment = (event) => {
    ...
    newigp[idx].comments.push({ username: "larryjackson41", text: event.target.firstChild.value});
