...
class App extends Component {
  ...
  clickSubmitComment = () => {
    ...
    newComments.push({ username: this.state.adusr, text: this.state.adtxt });
    this.setState({ adusr: "", adtxt: "" });
  };
    ...
    return (
      <div className="App">
        ...
        <PostContainer
          list={filteredPosts}
          inputName="adcmt"
          textOnProps={this.state.adcmt}
          handleInputOnProps={this.handleInput}
          clickSubmitComment={this.clickSubmitComment}
        />
      </div>
    );
  }
