        ...
        <div className = "post-container">
            ...
            <div className = "like-section">
              <div className = "like-icons" >
                <img className = "heart-likes" src = "https://imageog.flaticon.com/icons/png/512/30/30767.png?size=1200x630f&pad=10,10,10,10&ext=png&bg=FFFFFFFF" />  
              ...
              <div className="likes">{this.props.dummyObj.likes} likes</div>
