  ...
  return (
    <div className="d-flex flex-column align-items-start justify-content-start">
      <h2 className="header d-flex align-items-center justify-content-center">
        <img className="thumbnail-img" src={props.data.thumbnailUrl} alt="" />
        <span className="username username-header">{props.data.username}</span>
      </h2>
      ...
      <div className="likes-text">
        <span className="username">{props.data.likes} likes</span>
      </div>
    </div>
  );
};
