...
import "../CommentContent/CommentContent.css";
import "../CommentSection/CommentSection.css";
import "../DynamicInput/DynamicInput.css";
import "../PostContainer/PostContainer.css";
import "../PostContent/PostContent.css";
import "../PostContainer/PostPage.css";
        ...
        <div className="postpage">
          <header className="pstpg-header">
            <div className="left-header">
              ...
              <span className="pstpg-title">Instagram</span>
            </div>
            <DynamicInput
              inputName="filpt"
