...
import {HeaderContainer, SearchWrapper, Image, SearchBrandWrapper, Search, Input, SearchIcons} from "./header-styles";
      ...
      <SearchWrapper>
       <SearchBrandWrapper>
        ...
        <div>
          ...
          <SearchIcons src={profile} alt="profile" onClick={props.handleLogOut}/>
        </div>
      </SearchWrapper>
    </HeaderContainer>
  );
