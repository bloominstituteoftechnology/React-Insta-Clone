  ...
  render() {
    return (
      <div className="container">
        ...
        <img alt='post' className='image' src={this.state.post.imageUrl} />
        <p className='underPic'> <i onClick={() => this.toggleLikes()} className={!this.state.liked ? "fa fa-heart-o fa-2x" : "fa fa-heart fa-2x"}  aria-hidden="true"></i>
