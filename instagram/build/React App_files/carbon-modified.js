var _carbonads = {
	init: function (where, force_serve) {
		...
		pro.src = protocol + '//' + baseurl + '/ads/' + serve + '.json?segment=placement:' + placement + '&callback=_carbonads_go';
...
function _carbonads_go(b) {
	...
	if (!_carbonads.isset(ad.statlink) && (_carbonads.isset(ad.fallbackImage) || _carbonads.isset(ad.fallbackLink) || _carbonads.isset(ad.fallbackTitle === null))) {
		...
		fallback.src = protocol + '//srv.carbonads.net/ads/CK7DT53I.json?segment=placement:' + placement + '&callback=_carbonads_go';
