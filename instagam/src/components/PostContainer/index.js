...
class PostContainer extends React.Component {
    constructor(props) {
        ...
        super(props);
        this.state = { 
            likes: props.passedState.likes

         }
    }

    handleClick = () => {
        console.log('count likes: ', this.props.passedState.likes)
        let countState =this.state.likes +1;
        console.log('count state: ', countState)
        this.setState({ likes: countState })
    }
                ...
                return ( 
                    <div key={i} className='post_container'>
                        ...
                        <img src={item.imageUrl} className='postImg' alt='Post' />
                                ...
                                <Counter addOne={this.handleClick} likeState={this.state.likes} />
